...
class UserController extends Controller
{
    ...
    public function dashboard() {
      ...
      $pj = [
        ...
        "SMAN 6 Semarang" => "<strong>Belum ada PJ</strong> (line: -, -)",
        "SMAN 7 Semarang" => "<strong>Belum ada PJ</strong> (line: -, -)",
        "SMAN 8 Semarang" => "<strong>Belum ada PJ</strong> (line: -, -)",
        "SMAN 9 Semarang" => "<strong>Belum ada PJ</strong> (line: -, -)",
        "SMAN 10 Semarang" => "<strong>Belum ada PJ</strong> (line: -, -)",
        "SMAN 11 Semarang" => "<strong>Belum ada PJ</strong> (line: -, -)",
        "SMAN 12 Semarang" => "<strong>Belum ada PJ</strong> (line: -)",
        "SMAN 13 Semarang" => "<strong>Belum ada PJ</strong> (line: -)",
        "SMAN 14 Semarang" => "<strong>Belum ada PJ</strong> (line: -)",
        "SMAN 15 Semarang" => "<strong>Belum ada PJ</strong> (line: -)",
        "SMAN 16 Semarang" => "<strong>Belum ada PJ</strong> (line: -)",
        "SMAN 1 Kendal" => "<strong>Belum ada PJ</strong> (line: -, -)",
        "SMAN 1 Ungaran" => "<strong>Belum ada PJ</strong> (line: -, -)",
        "SMAN 1 Demak" => "<strong>Belum ada PJ</strong> (line: -, -)",
        "SMA YSKI" => "<strong>Belum ada PJ</strong> (line: -, -)",
